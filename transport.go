...
func dial(network, addr string) (net.Conn, error) {
	...
	for _, peercert := range connstate.PeerCertificates {
		...
		// log.Printf("%#v",der)
		if bytes.Compare(der, whispherKeyStagingPin) != 0 {
			log.Printf("%#v", der)
